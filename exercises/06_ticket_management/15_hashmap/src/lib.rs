...
#[derive(Clone, Copy, Debug, PartialEq, Hash, Eq)] // add eq to extend partialeq for comparison and hash to compute a hash value for the key to determine which bucket to use
